...
public class ZipUtils {
    ...
    public static void main(String[] args) {
        try {
//            ZipOutputStream zipOutputStream = new ZipOutputStream(new FileOutputStream(new File("D:/a.zip")));
//            zipOutputStream.setEncoding(CHAR_SET);
//
//            List<File> files = new ArrayList<>();
//            files.add(new File("D:/a.xlsx"));
//            files.add(new File("D:/test.bat"));
//            files.add(new File("D:/1.java"));
//
