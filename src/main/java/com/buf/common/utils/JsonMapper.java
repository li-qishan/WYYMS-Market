...
//        }));
    ...
    public <T> T fromJsonString(String jsonString, Class<T> clazz) {
        if (org.apache.commons.lang3.StringUtils.isEmpty(jsonString) || "<CLOB>".equals(jsonString)) {
            return null;
        }
        try {
    ...
    public static List<Map<String, Object>> fromJsonForMapList(String jsonString){
        ...
        if (org.apache.commons.lang3.StringUtils.startsWith(jsonString, "{")){
            Map<String, Object> map = fromJson(jsonString, Map.class);
            if (map != null){
                result.add(map);
            }
        }else if (org.apache.commons.lang3.StringUtils.startsWith(jsonString, "[")){
