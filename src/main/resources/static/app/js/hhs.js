                ...
                !
                    function () {
                        function h(u, y) {
                            ...
                            var w;
                            if (y = y || {}, this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = y.touchBoundary || 10, this.layer = u, this.tapDelay = y.tapDelay || 200, this.tapTimeout = y.tapTimeout || 700, !h.notNeeded(u)) {
